// Self Healing Fire //
class StimulatorAltFire extends WeaponFire;
...
Function Timer()
{
	...
	SRHumanPawn(Instigator).Stimulate( HealSum, 30.0 + 1.0 * KFPlayerReplicationInfo(Instigator.PlayerReplicationInfo).ClientVeteranSkillLevel );
